...
% Last updated: October 30, 2005: Correct handling of file selection
%
...
%                {'times',first,last}; all samples with times between
...
%                trace headers. Examples: '10 <= cdp & 100 >= cdp'
...
%                header "lag" below) and applies the shift to to the seismic data;
