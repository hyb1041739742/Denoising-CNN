...
%
%   example:    [D,H] = ssort(D,H,'cdp') the traces are  
%               sorted in cdp's. 
%               This is also the default sorting which can
%               be invoked as [D,H] = ssort(D,H)
%
%   example:    [D,H] = ssort(D,H,'offset') traces are sorted 
%               in offset, this can be used to produce COFs and/or
%               super CMPs.
%               
%   NOTE: This is a poor-man version of what should be an important part
%         of SEISMIC_LAB. Don't try to use this code to sort large data
%         sets (use susort!).
%         
%
