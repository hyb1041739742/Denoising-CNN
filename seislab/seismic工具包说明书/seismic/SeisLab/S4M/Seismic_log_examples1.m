...
s_wplot(reflect,{'annotation','dt_error'})

%	Plot blow-up of the reflection coefficient series
s_wplot(reflect,{'times',450,750},{'annotation','dt_error'})
...
aux=s_wplot_with_header(wavelets,{'headers2plot','max','cc_wavelet'},{'deflection',1}, ...
   {'scale','no'},{'annotation','dt_error'},{'aindex',1:10})
legend(aux.legend_handle,'Maximum amplitude of wavelet','Correlation coefficient',3)
suptitle('Maximum wavelet amplitude vs. correlation coefficient')

%	Compute and display the spectra of the individual wavelets
s_spectrum(wavelets,{'single','yes'},{'frequencies',0,80})
