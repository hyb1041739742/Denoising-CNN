...
% them in a cell array; character groups must start with a letter and can contain numbers and
% underscores.
% Written by: E. R.: Date March 4, 2000;
% Last updated: December 7, 2000: words must satisfy the same rules as MATLAB variables

% INPUT 
% string	String to be analyzed
% OUTPUT
% words         Cell array containing all contiguous groups of letters including underscores
