...
% the water depth and possibly the Kelley bushing are available as parameters
% ('wd' and 'ekb', respectively) of the well log. Ther must also be a field 
% 'parameter-info'. If these parameters are already in the las file they will
% be automatically transfered to the log structure)
...
%       Check if there is a curve OWt and or TWT
if strcmp(dunits,'ft')
   wt1=wd/4888;
else
   wt1=wd/1490;
